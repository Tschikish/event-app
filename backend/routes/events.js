...
import { fetchEvent, fetchAllEvents,  pushEvent, pushMultipleEvents, postDefaultEvent, fetchEvents } from "../controllers/eventController.js";
...
router.get("getmultiple", fetchEvents);
